...
Description:
  EKF (Extended Kalman Filter) — 최적 AHRS 필터
...
class EkfFilter(AhrsFilter):
    """EKF AHRS Filter. state: q(4) + gyro_bias(3)."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # 공분산: error-state 6×6 (attitude error dθ[3] + bias[3])
    ...
    def _ekf_update(self, z: np.ndarray, h: np.ndarray,
        ...
        # 소각도 섭동 적용: q ← q ⊗ [dθ/2, 1] (normalized)
