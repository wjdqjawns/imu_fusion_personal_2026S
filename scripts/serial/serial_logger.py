...
PLOT_GROUPS = [
    ...
    },
    {
        ...
        "ylabel": "[deg]",
        "channels": [
            {"col": ROLL_CF_COL, "label": "CF", "color": "#378ADD", "ls": "-"},
            {"col": ROLL_KF_COL, "label": "KF", "color": "#E24B4A", "ls": "--"},
        ],
    },
    {
        "title": "Pitch",
        "ylabel": "[deg]",
        "channels": [
            {"col": PITCH_CF_COL, "label": "CF", "color": "#378ADD", "ls": "-"},
            {"col": PITCH_KF_COL, "label": "KF", "color": "#E24B4A", "ls": "--"},
        ],
    },
    {
        "title": "Yaw",
        "ylabel": "[deg]",
        "channels": [
            {"col": YAW_CF_COL, "label": "CF", "color": "#378ADD", "ls": "-"},
            {"col": YAW_KF_COL, "label": "KF", "color": "#E24B4A", "ls": "--"},
        ],
    },
]
...
if MODE_DATA == "REAL":
    ...
    from scripts.mock_serial import MockSerial
    ser = MockSerial()
...
fig = plt.figure(figsize=(14, 2.5 * n_groups), facecolor="#1a1a1a")
...
# ── 그룹 subplot 초기화 ───────────────────────────────────
all_lines = []   # all_lines[g_idx][c_idx]
...
# ── Error Norm subplot ────────────────────────────────────
ax_err = axes[-1]
(err_line,) = ax_err.plot([], [], color="#EF9F27", linewidth=1.0, label="‖CF−KF‖")
